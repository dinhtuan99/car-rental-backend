...
**Ghi chú:** Số liệu trong slide được đánh dấu nguồn: `[ƯT]` = ước tính dựa trên dữ liệu thị trường, `[MT]` = mục tiêu nội bộ, `[DB]` = dựa trên quan sát thực địa. Không có số liệu khảo sát thực tế trong bản trình bày này.
...
**Vì sao quan trọng:** Khách du lịch tại các điểm như Đà Nẵng, Nha Trang chủ yếu là người từ nơi khác đến — họ cần đặt xe nhanh, không có nhu cầu tạo tài khoản cho một lần thuê. Nếu bắt buộc đăng ký, tỷ lệ bỏ cuộc sẽ cao.
...
Chưa có phân tích đối thủ chính thức. Dựa trên quan sát ban đầu:

- **Phần mềm quản lý vận tải:** Một số sản phẩm trên thị trường tập trung vào xe có lái (quản lý tài xế, tour, điều phối) — khác phân khúc với xe tự lái
- **Add-on của PMS:** Một số PMS khách sạn/nhà hàng có thêm module rental car nhưng không phải sản phẩm chính
- **Excel/Zalo/sổ giấy:** Phần lớn shop xe tự lái nhỏ đang dùng — đây mới là "đối thủ" thực sự cần thay thế
...
**Cần làm:** Phân tích cạnh tranh chính thức (tên sản phẩm, giá, tính năng, phân khúc) trước khi đưa vào pitch deck.

---

## Slide 5: Khách Vãng Lai vs Khách Thường Xuyên

### Giả định về phân bổ khách hàng

Chưa có số liệu khảo sát thực tế. Các giả định dưới đây dựa trên suy luận từ bản chất thị trường xe tự lái du lịch:

```
Tại sao guest được ưu tiên trong thiết kế MVP:

  • Điểm du lịch (Đà Nẵng, Nha Trang, Phú Quốc...) → phần lớn khách là người
    từ nơi khác đến, không phải dân địa phương
  • Khách du lịch thuê xe 1-2 lần/năm → không có nhu cầu tạo tài khoản
  • Họ tìm xe qua Google/Maps khi đã ở khách sạn → cần đặt được ngay

  → Guest checkout phải là flow chính, không phải flow phụ để "làm sau"
```

**Cần làm trước khi kết luận:** Khảo sát 30-50 nhà xe để có tỷ lệ Guest/Member thực tế. Tỷ lệ này sẽ khác nhau theo địa điểm và loại hình nhà xe.

### Đặc điểm 2 nhóm khách (giả định dựa trên quan sát thị trường)
...
| **Tần suất thuê** | 1-2 lần/năm (thuê xe ở nơi họ ĐẾN, không phải nơi họ SỐNG) | 1-4 lần/tháng (thuê ở nơi họ SỐNG) |
...
| **Phần mềm hiện có** | Một số sản phẩm quản lý vận tải đã có mặt trên thị trường | Phân mảnh, chưa có player SaaS rõ ràng |
...
| 3 | **Ít đối thủ SaaS hơn** | Xe có lái đã có một số sản phẩm quản lý vận tải chuyên dụng. Xe tự lái phần lớn dùng Excel/Zalo, chưa có SaaS player chiếm lĩnh |
...
Nhà xe nhỏ & vừa tại điểm du lịch đang dùng Excel/Zalo/sổ giấy để quản lý. Họ không có web riêng để khách đặt xe online. Các phần mềm hiện tại trên thị trường hoặc có chi phí cao, hoặc không có multi-tenant/web riêng.
...
| **Guest checkout** | Khách vãng lai đặt xe không cần tài khoản — phù hợp với hành vi khách du lịch tại điểm đến |
...
3. **Tỷ lệ Guest/Member** — Chưa có số liệu thực tế, cần khảo sát để xác nhận giả định
