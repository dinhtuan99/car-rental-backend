...
Mỗi key feature thuộc về một module cụ thể. Đây là 4 thứ quyết định nhà xe có dùng sản phẩm hay không.
...
**Vì sao quan trọng:** `[DB]` Qua trao đổi với một số nhà xe, vấn đề họ gặp nhiều nhất là khách vào web thấy xe trống nhưng ra quầy hết xe. Nếu inventory không chính xác, mọi tính năng khác trở nên vô nghĩa.
...
**Vì sao quan trọng:** `[DB]` Nhân viên nhà xe dùng thao tác giao/nhận xe nhiều lần mỗi ngày (với shop 20-30 xe, ước tính 10-30 lượt/ngày mùa thấp điểm, 30-60 lượt/ngày mùa cao điểm). Nếu thao tác chậm hơn ghi sổ, họ sẽ bỏ phần mềm.
...
Không phải mọi tính năng đều quan trọng như nhau. Với đối tượng nhà xe nhỏ & vừa (10-50 xe), 3 thứ sau quyết định họ có trả tiền hay không:
...
Ưu tiên cao nhất:
  ...
  3. DỮ LIỆU RIÊNG — WEB RIÊNG
     └── Nhà xe đăng ký → 5 phút sau có web riêng chạy được, data cô lập tuyệt đối
...
| Lý do | Giải thích |
|-------|------------|
| **Form/Table/CRUD** | Dashboard nặng form nhập liệu, bảng quản lý, CRUD. Angular Reactive Forms + RxJS mạnh nhất cho tác vụ này. |
...
2. TEAM SKILL > PERFECT TECH
   → Công nghệ tốt nhất = công nghệ team thực sự dùng được
...
Nhà xe nhỏ & vừa tại điểm du lịch đang dùng Excel/Zalo/sổ giấy để quản lý. Họ không có web riêng để khách đặt xe online. Các phần mềm hiện tại hoặc quá đắt (Nanosoft), hoặc không có multi-tenant/web riêng.
